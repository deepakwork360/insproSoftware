        ...
        <section className="relative w-full aspect-video md:aspect-auto md:h-[70vh] lg:h-[80vh] overflow-hidden">
            ...
            <div className="banner-hud-container">
                ...
                <div className="hud-content">
                    ...
                    {title && (
                        <h1 className="banner-head-hud !text-white !text-2xl md:!text-3xl lg:!text-5xl xl:!text-6xl !mb-4 max-w-4xl animate-in fade-in slide-in-from-left duration-1000 delay-100">
                            {title}
                        </h1>
                    )}

                    {description && (
                        <p className="banner-para-hud hidden md:block !text-white/70 !max-w-5xl !text-xs md:!text-sm lg:!text-base animate-in fade-in slide-in-from-left duration-1000 delay-200">
                            {description}
                        </p>
                    )}
