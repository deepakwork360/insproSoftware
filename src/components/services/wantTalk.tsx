      ...
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-8">
        ...
        <div className="space-y-4">
          <div className="inline-flex items-center gap-3">
            ...
            <span className="text-[var(--primary)] text-sm font-playfair font-medium">
              Ready To Start?
            </span>
          </div>
        ...
        <div className="flex-shrink-0">
          <Link href="/contact" className="group relative inline-flex items-center gap-4 px-8 py-4 bg-[var(--primary)] text-white text-sm font-bold uppercase tracking-[0.2em] transition-all duration-500 hover:bg-accent hover:shadow-2xl hover:shadow-[var(--primary)]/20 overflow-hidden">
            {/* Button Glint Effect */}
