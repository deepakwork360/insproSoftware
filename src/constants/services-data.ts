...
export const servicesData: Record<string, ServicePageData> = {
  ...
  "iot-app-development": {
    ...
    cards: [
      ...
      { title: "Enterprise Solution", description: "Enterprise solutions deliver secure and scalable platforms for real-time data management, device coordination, and seamless connectivity across all IoT ecosystems.", image: "/services/graphic1.png" },
