        ...
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full h-full pointer-events-none overflow-hidden opacity-40">
            ...
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] flex items-center justify-center">
                <svg className="w-full h-full text-primary/40" viewBox="0 0 200 200">
                    ...
                    <g className="animate-[spin_120s_infinite_linear] will-change-transform" filter="url(#glow)">
                    ...
                    <g className="animate-[spin_40s_infinite_linear_reverse] will-change-transform" filter="url(#glow)">
                    ...
                    <g className="animate-[spin_20s_infinite_linear] will-change-transform" filter="url(#glow)">
...
BackgroundHUD.displayName = "BackgroundHUD";
        ...
        <section className="relative bg-background py-10 px-6 md:px-12 lg:px-24 overflow-hidden border-t border-border/10">
            ...
            <div className="max-w-7xl mx-auto relative z-10">
                <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-start">
                    ...
                    <div id="footer-cta" className="relative scroll-mt-24 md:scroll-mt-32">
                        {/* Decorative Background for Form */}
                        <div className="absolute -inset-10 bg-primary/5 rounded-full blur-[100px] opacity-50 pointer-events-none" />
                        
                        <ImageContainer id="CONTACT_FORM_v1" className="p-6 md:p-12 relative z-10" showBackground={true} showLabel={false}>
                            {isSuccess ? (
                                ...
                                <form className="space-y-5 md:space-y-6" onSubmit={handleInitialSubmit}>
                                    ...
                                    <button 
                                        ...
                                        className="group relative inline-flex cursor-pointer w-full items-center justify-center gap-4 md:gap-6 px-6 md:px-12 py-4 md:py-5 bg-[var(--primary)] text-white text-[10px] md:text-xs font-bold uppercase tracking-[0.2em] transition-all duration-500 hover:bg-accent hover:shadow-2xl hover:shadow-[var(--primary)]/20 overflow-hidden disabled:opacity-50 disabled:cursor-not-allowed"
                                    >
                                        {/* Button Glint Effect */}
