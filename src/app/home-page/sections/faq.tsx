    ...
    return (
        <div className={`group border-b border-border/40 transition-all duration-700 relative ${isOpen ? "bg-primary/[0.04] backdrop-blur-sm" : "hover:bg-primary/[0.01]"}`}>
            ...
            >
                ...
                <div className="flex flex-col gap-2 md:flex-row md:items-center relative z-10 pr-14">
...
interface FAQProps {
    customFaqs?: { que: string; ans: string }[];
    title?: string;
...
export default function FAQ({ 
    ...
    description = "Find answers to common queries about our processes, technologies, and specialized services."
}: FAQProps) {
